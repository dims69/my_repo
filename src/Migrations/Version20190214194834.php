 ...
 */
final class Version20190214194834 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apropos CHANGE description description VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apropos CHANGE description description VARCHAR(1024) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
